...
public class gestion_monitoreo_museos_inteligentes {
    ...
    // El sistema debe registrar información sobre piezas de arte, temperatura ambiental, 
    // niveles de humedad, iluminación y movimientos de personas dentro de las diferentes salas del museo. 

    // La complejidad del problema surge porque muchas obras poseen un valor histórico incalculable
    // y requieren condiciones ambientales estrictamente controladas para evitar deterioro. 

    // El programa debe analizar continuamente datos de sensores ambientales para detectar cambios peligrosos de temperatura, 
